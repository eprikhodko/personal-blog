...
```jsx file=src/Favorite.js highlights=5-7
...
Этот компонент рендерит сердечко. Когда мы кликаем на сердце, оно становится красным, или наоборот, пустым. Как будто мы ставим лайк.
...
![UI исходного приложения](heart-click-animation.gif)
